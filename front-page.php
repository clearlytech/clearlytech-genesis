...
add_action( 'genesis_before_content_sidebar_wrap', 'ct_featured_tiles');

function ct_featured_tiles() {
	echo do_shortcode("[post-tiles]");
}

add_action( 'genesis_meta', 'ct_home_widget_test' );
