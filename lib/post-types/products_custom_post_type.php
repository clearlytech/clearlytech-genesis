...
add_action( 'init', 'ct_register_products_post_type' );

function ct_register_products_post_type() {
	$labels = array(
		'name' => 'Products',
...
add_action( 'init', 'ct_product_categories_taxonomies', 0 );

function ct_product_categories_taxonomies() {
  $labels = array(
